    ...
    <div className="min-h-screen bg-slate-50 text-slate-900 dark:bg-slate-950 dark:text-slate-100 font-sans selection:bg-blue-200 dark:selection:bg-blue-900">
      ...
      <header className="max-w-5xl mx-auto px-6 py-20 lg:py-32 text-center relative">
        ...
        <div className="relative z-10">
          <div className="inline-flex items-center justify-center p-4 bg-white dark:bg-slate-900 shadow-xl rounded-2xl mb-8 border border-slate-200 dark:border-slate-800">
      ...
      <main className="max-w-7xl mx-auto px-6 pb-24 space-y-32">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4">
              <div className="p-4 rounded-xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 flex gap-4">
            ...
            <div className="relative bg-white dark:bg-slate-900 p-8 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-2xl overflow-hidden">
              ...
              <div className="space-y-6 relative z-10">
                <div className="flex items-center gap-6">
                  <div className="w-12 h-12 rounded-full bg-slate-100 dark:bg-slate-800 flex items-center justify-center font-black text-xl text-slate-300 dark:text-slate-600">01</div>
                  <div>
                    <h4 className="font-bold text-lg text-slate-900 dark:text-white">Input Normalization</h4>
                    <p className="text-sm text-slate-500">Image is resized to 224x224 and pixel values are scaled.</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-6">
                  <div className="w-12 h-12 rounded-full bg-slate-100 dark:bg-slate-800 flex items-center justify-center font-black text-xl text-slate-300 dark:text-slate-600">02</div>
                  <div>
                    <h4 className="font-bold text-lg text-slate-900 dark:text-white">Feature Extraction</h4>
                    <p className="text-sm text-slate-500">The CNN sweeps for edges, textures, and geometric anomalies.</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-6">
                  <div className="w-12 h-12 rounded-full bg-blue-600 text-white flex items-center justify-center font-black text-xl shadow-lg shadow-blue-500/30">03</div>
                  <div>
                    <h4 className="font-bold text-lg text-slate-900 dark:text-white">Classification</h4>
                    <p className="text-sm text-slate-500">Probability scores are assigned to each of the 4 classes.</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="p-8 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 hover:border-emerald-200 dark:hover:border-emerald-900 transition-colors group">
              ...
              <h3 className="text-xl font-bold mb-3 text-slate-900 dark:text-white">Real Photo</h3>
            ...
            <div className="p-8 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 hover:border-purple-200 dark:hover:border-purple-900 transition-colors group">
              ...
              <h3 className="text-xl font-bold mb-3 text-slate-900 dark:text-white">AI Generated</h3>
              <p className="text-sm text-slate-500 leading-relaxed">
            ...
            <div className="p-8 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 hover:border-cyan-200 dark:hover:border-cyan-900 transition-colors group">
              <div className="w-14 h-14 bg-cyan-50 dark:bg-cyan-900/20 text-cyan-600 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
                <Layers className="w-7 h-7" />
              </div>
              <h3 className="text-xl font-bold mb-3 text-slate-900 dark:text-white">3D Render</h3>
              <p className="text-sm text-slate-500 leading-relaxed">
            ...
            <div className="p-8 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 hover:border-orange-200 dark:hover:border-orange-900 transition-colors group">
              ...
              <h3 className="text-xl font-bold mb-3 text-slate-900 dark:text-white">2D Art</h3>
              <p className="text-sm text-slate-500 leading-relaxed">
        ...
        {/* ANALYSIS DEPTH */}
        <section className="bg-slate-900 rounded-[3rem] p-10 md:p-20 text-white relative overflow-hidden">
          ...
          <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <div className="bg-slate-800/50 backdrop-blur-sm border border-slate-700 p-8 rounded-3xl flex flex-col justify-center items-center text-center">
              <div className="mb-6 p-4 bg-slate-900 rounded-full inline-block">
              ...
              <Link 
                href="/" 
                className="inline-flex items-center gap-2 px-8 py-4 bg-white text-slate-900 rounded-full font-bold hover:scale-105 transition-transform shadow-xl shadow-indigo-900/20"
              >
